...
function SfxSection({ sfxData, sfxForm, setSfxForm, busy, createSfx, onDelete, data, saveSettings }) {
  if (!sfxData) {
    ...
    <>
      ...
      <Card title="Sound effects" sub="whether the DJ agent uses stingers at all">
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 700 }}>Enable sound effects</div>
            <div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 2, maxWidth: 480, lineHeight: 1.5 }}>
      ...
      {!ready && (
        <div className="card">
          <div className="card-body" style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.5 }}>
            <strong style={{ letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--ink)' }}>
