...
## [0.42.0](https://github.com/LYKNV/subwave/compare/v0.41.0...v0.42.0) (2026-07-13)


### Features

* add Requesty as an OpenAI-compatible LLM provider ([#539](https://github.com/LYKNV/subwave/issues/539)) ([ebd4521](https://github.com/LYKNV/subwave/commit/ebd4521281cc74dc6789faa3f8f4fccd54291b54))
* **admin/shows:** add blacklisted playlists to shows ([#779](https://github.com/LYKNV/subwave/issues/779)) ([85d275e](https://github.com/LYKNV/subwave/commit/85d275e2d71568400b7bd1ce1c88a97ea27c3d62))
* **admin/shows:** Any mood option + unified Strict filter toggle ([#766](https://github.com/LYKNV/subwave/issues/766)) ([4b4f1dc](https://github.com/LYKNV/subwave/commit/4b4f1dc6d006c2d89cb0a2547a12baa7402e857b))
* **admin/tagger:** add option to change batch size for LLM tagging ([6e75e39](https://github.com/LYKNV/subwave/commit/6e75e39fd428a89d7825dbe411139cb37f383b23))
* **admin:** add "Reconcile with Navidrome" to prune deleted tracks from the library ([#424](https://github.com/LYKNV/subwave/issues/424)) ([fe50bd4](https://github.com/LYKNV/subwave/commit/fe50bd4b5419570905cb2927d4071654a22ab9fb))
* **admin:** add icons + light inactive bg to settings sidebar tabs ([#653](https://github.com/LYKNV/subwave/issues/653)) ([a8b51f7](https://github.com/LYKNV/subwave/commit/a8b51f7b16c54ea078888a7c724c809531288843))
* **admin:** add Ko-fi and Discord links to the sidebar ([#1020](https://github.com/LYKNV/subwave/issues/1020)) ([1bf3ea7](https://github.com/LYKNV/subwave/commit/1bf3ea74c3b3e50a569905362bbb2f257ec1b551))
* **admin:** add Manual link to bottom of admin sidebar ([#408](https://github.com/LYKNV/subwave/issues/408)) ([1b7b9d1](https://github.com/LYKNV/subwave/commit/1b7b9d13f5227b358d5ae4e257c457e24df60f74))
* **admin:** adopt AI Elements components across the admin panels ([#1009](https://github.com/LYKNV/subwave/issues/1009)) ([08a2a43](https://github.com/LYKNV/subwave/commit/08a2a43594bd2ecb4eab9101a1edb1f4a1ebb41b))
* **admin:** AI "describe it → auto-fill" for personas, shows & themes ([#492](https://github.com/LYKNV/subwave/issues/492)) ([7e77451](https://github.com/LYKNV/subwave/commit/7e77451d0fcdd56785c478d1a3dedc51394745d4))
* **admin:** anchor the dash latency redline to the DJ-agent deadline ([#392](https://github.com/LYKNV/subwave/issues/392)) ([b110954](https://github.com/LYKNV/subwave/commit/b1109547b6d4e1b641866c49329dfede2825d225))
* **admin:** backup/restore station config + tag DB to a zip ([#410](https://github.com/LYKNV/subwave/issues/410)) ([26b2ca0](https://github.com/LYKNV/subwave/commit/26b2ca0142bc6d373fdc3b5b41ad645b37f923cf))
* **admin:** booth-log prompt summaries, shadcn scroll areas, segment fire pads ([#958](https://github.com/LYKNV/subwave/issues/958)) ([5897729](https://github.com/LYKNV/subwave/commit/5897729de48afd95afc615e1ea5a158c17d32dc4))
* **admin:** cancel button for queued tracks on the dash ([#1006](https://github.com/LYKNV/subwave/issues/1006)) ([0e6a2f9](https://github.com/LYKNV/subwave/commit/0e6a2f90ea9235deb07f942d79f564a5db2b0c32))
* **admin:** card-grid embedding provider picker for the library tagger ([#649](https://github.com/LYKNV/subwave/issues/649)) ([a61ed6b](https://github.com/LYKNV/subwave/commit/a61ed6b572fd2539072b34e3d36fb5fde0168b63))
* **admin:** card-grid LLM provider & TTS engine pickers + onboarding model dropdown ([#645](https://github.com/LYKNV/subwave/issues/645)) ([df052e7](https://github.com/LYKNV/subwave/commit/df052e7ad528599f25c275f6a3069fe33bdc9e25))
* **admin:** city-search location picker with auto timezone ([#656](https://github.com/LYKNV/subwave/issues/656)) ([c325995](https://github.com/LYKNV/subwave/commit/c325995ee5097b05bac66c62d68c141c9bfb709d))
* **admin:** clear-archive button + DELETE /archives endpoint ([#648](https://github.com/LYKNV/subwave/issues/648)) ([189fe77](https://github.com/LYKNV/subwave/commit/189fe77fc9bf01ccef48a149511e64396f1698ce))
* **admin:** DJ Doc — station diagnostics + LLM review ([#582](https://github.com/LYKNV/subwave/issues/582)) ([379ca1d](https://github.com/LYKNV/subwave/commit/379ca1df1b37beef67543ae2193815a8fe726db0))
* **admin:** enrich Stats page — listener trend chart, cost, request analytics ([#427](https://github.com/LYKNV/subwave/issues/427)) ([0652d78](https://github.com/LYKNV/subwave/commit/0652d7841b5735247fcac9515fec9035dcf4257f))
* **admin:** fold Archives/Webhooks/Backup into Settings + tighten app links ([#420](https://github.com/LYKNV/subwave/issues/420)) ([92695df](https://github.com/LYKNV/subwave/commit/92695df82de73272103e7a057454a7f7f91f46af))
* **admin:** full-screen editor dialog + unified list cards ([#708](https://github.com/LYKNV/subwave/issues/708)) ([d0ebf16](https://github.com/LYKNV/subwave/commit/d0ebf16ce26941dead52e5c61661689c0c6efa1c))
* **admin:** library search paging, sounds-like search mode, URL-persisted state ([#967](https://github.com/LYKNV/subwave/issues/967)) ([5049787](https://github.com/LYKNV/subwave/commit/504978700c5a0ab0e09be118e8a53e64db63cb57))
* **admin:** library tagging & embedding-config UX for new operators ([#730](https://github.com/LYKNV/subwave/issues/730)) ([583ef82](https://github.com/LYKNV/subwave/commit/583ef82927326fa0abd34869f2305c984df6fd93))
* **admin:** per-call TTS log in the debug panel's TTS routing card ([#960](https://github.com/LYKNV/subwave/issues/960)) ([a24a5c3](https://github.com/LYKNV/subwave/commit/a24a5c307375109753879e51920f3bdf89088f5c))
* **admin:** radio-card TTS engine picker + voice preview ([#151](https://github.com/LYKNV/subwave/issues/151)) ([#640](https://github.com/LYKNV/subwave/issues/640)) ([96b4116](https://github.com/LYKNV/subwave/commit/96b41160bc14d85d67199e518990beec751c0881))
* **admin:** reorder theme tab, left-align create button, add theme removal ([#651](https://github.com/LYKNV/subwave/issues/651)) ([6d85600](https://github.com/LYKNV/subwave/commit/6d856001e344394916bcd99bc72878f886b34579))
* **admin:** searchable model discovery dropdown for all providers ([#615](https://github.com/LYKNV/subwave/issues/615)) ([9936a4b](https://github.com/LYKNV/subwave/commit/9936a4b5338429fdfca984134b0dbd3703dd9061))
* **admin:** show listener requests + DJ responses on dashboard ([#386](https://github.com/LYKNV/subwave/issues/386)) ([95fb395](https://github.com/LYKNV/subwave/commit/95fb39504ba71d24a83031c81647e41a16c4d159))
* **admin:** station timezone setting driving the DJ clock ([#357](https://github.com/LYKNV/subwave/issues/357)) ([dcabaf0](https://github.com/LYKNV/subwave/commit/dcabaf0a1cf47ede174a9220c7e2de09fffd889e)), closes [#353](https://github.com/LYKNV/subwave/issues/353)
* **admin:** support multi-file jingle import ([#952](https://github.com/LYKNV/subwave/issues/952)) ([990b035](https://github.com/LYKNV/subwave/commit/990b0351f1e7305fbed3df11cc301d1a1ea31a78))
* **admin:** surface Navidrome-unreachable banner across admin ([#1014](https://github.com/LYKNV/subwave/issues/1014)) ([978ebf9](https://github.com/LYKNV/subwave/commit/978ebf92cd430ce01ad1d27b4a24559ecd6910fd))
* **analysis:** richer acoustic analysis (phases 1–6) ([#372](https://github.com/LYKNV/subwave/issues/372)) ([300d0de](https://github.com/LYKNV/subwave/commit/300d0deae43905fabc136e1d1588f9410ebdf6d5))
* **analyzer:** multi-window CLAP, text-tower search & audio moods, outro-aware transitions ([#894](https://github.com/LYKNV/subwave/issues/894)) ([eddc138](https://github.com/LYKNV/subwave/commit/eddc138e4dfe3c9336d0063ecd2d0fee7caa06dc))
* **analyzer:** split acoustic analyzer into a default-on standalone sidecar image ([#717](https://github.com/LYKNV/subwave/issues/717)) ([1f790aa](https://github.com/LYKNV/subwave/commit/1f790aaca5fdd42415cd14b50c5467a1defe6e8d))
* **api:** /listen.pls + /listen.m3u tune-in endpoints + now-playing stream block ([#670](https://github.com/LYKNV/subwave/issues/670)) ([0b1f48f](https://github.com/LYKNV/subwave/commit/0b1f48f10f622a130cf9310ac641fff06f9d7244))
* **app:** browse community stations in the Discover list ([#375](https://github.com/LYKNV/subwave/issues/375)) ([f718390](https://github.com/LYKNV/subwave/commit/f71839037dd1fc8829f5db8b8f11e9f868a9c159))
* **app:** diagnose connection failures and add an HTTP/HTTPS toggle in onboarding ([#458](https://github.com/LYKNV/subwave/issues/458)) ([#527](https://github.com/LYKNV/subwave/issues/527)) ([1762793](https://github.com/LYKNV/subwave/commit/17627933f74e92e1face2cba4dc63171da064b5b))
* **app:** dock player bar across all screens + slim live now-playing ([#366](https://github.com/LYKNV/subwave/issues/366)) ([f330155](https://github.com/LYKNV/subwave/commit/f3301554f36b153e6e0d9c4435531848145dc92c))
* **app:** glassy frosted transport bar ([#376](https://github.com/LYKNV/subwave/issues/376)) ([ab33346](https://github.com/LYKNV/subwave/commit/ab33346e1937bd8f309389eb479155a60051d5fb))
* **app:** production-readiness — resilience UX, OTA, store config + docs ([#345](https://github.com/LYKNV/subwave/issues/345)) ([3622940](https://github.com/LYKNV/subwave/commit/3622940e024c43e935870806cc48d2935793c3cc))
* **app:** show Discover stations on first-load onboarding ([#389](https://github.com/LYKNV/subwave/issues/389)) ([dde8d9b](https://github.com/LYKNV/subwave/commit/dde8d9b22c8af6858ce9af2993408f9f912fbff4))
* **app:** support HTTP (cleartext) stations on iOS and Android ([#464](https://github.com/LYKNV/subwave/issues/464)) ([dfe8fbf](https://github.com/LYKNV/subwave/commit/dfe8fbf2de5491fdfb3a4fc7610f8a2cfd05db42))
* **app:** surface Now-Playing on CarPlay & Android Auto ([#444](https://github.com/LYKNV/subwave/issues/444)) ([59da3a4](https://github.com/LYKNV/subwave/commit/59da3a409ec0c4ac7d5242767dd9eada308bff3e))
* **app:** trust user-installed CAs on Android & clarify TLS failures ([#458](https://github.com/LYKNV/subwave/issues/458)) ([#550](https://github.com/LYKNV/subwave/issues/550)) ([1327ec9](https://github.com/LYKNV/subwave/commit/1327ec99d11b7f19f3a310832f856fc4a758e21a))
* **app:** web-player parity, sleep timer, Google Cast + AirPlay connectivity ([#970](https://github.com/LYKNV/subwave/issues/970)) ([0b060a3](https://github.com/LYKNV/subwave/commit/0b060a3a2c69b525af6913ee43033043f9c2c9f3))
* **archive:** disable hourly archives by default ([#933](https://github.com/LYKNV/subwave/issues/933)) ([e619e77](https://github.com/LYKNV/subwave/commit/e619e776482a34a7cc5515e4f5a674218ed0572f))
* **audio:** configurable loudness target + peak-aware asymmetric gain clamp ([#758](https://github.com/LYKNV/subwave/issues/758)) ([1b10331](https://github.com/LYKNV/subwave/commit/1b10331b7da45b219d9fc9b38efafaca1bf37133))
* **boardcast:** configurable stream bitrate ([#676](https://github.com/LYKNV/subwave/issues/676)) ([85a9d18](https://github.com/LYKNV/subwave/commit/85a9d18626f66ffe057089c62b0cdb539bd16a54))
* **broadcast:** "chop" DJ transition — accelerating beat-synced crossfader cut ([#861](https://github.com/LYKNV/subwave/issues/861)) ([5d3ebc2](https://github.com/LYKNV/subwave/commit/5d3ebc2893f9ad0881f7b827fed206abfed2d9cb))
* **broadcast:** air station idents at track boundaries, not mid-song ([#831](https://github.com/LYKNV/subwave/issues/831)) ([8653de7](https://github.com/LYKNV/subwave/commit/8653de771842cfcafd12e34275ee7b273e58f278))
* **broadcast:** configurable Icecast listener cap (ICECAST_MAX_CLIENTS) ([#978](https://github.com/LYKNV/subwave/issues/978)) ([3a56a1b](https://github.com/LYKNV/subwave/commit/3a56a1be2422efa9dfc47f215edcd09cdd27d627))
* **broadcast:** DJ-mode transition effects — filter sweep + echo washout ([#606](https://github.com/LYKNV/subwave/issues/606)) ([a919386](https://github.com/LYKNV/subwave/commit/a919386b9785f8ce24f14402f1d036dc4e6961fa))
* **broadcast:** upgrade Liquidsoap 2.2.5 → 2.4.4 ([#784](https://github.com/LYKNV/subwave/issues/784)) ([f43e10e](https://github.com/LYKNV/subwave/commit/f43e10e4048da91e55f442cc99a6200b1ba68869))
* cap max track length for autonomous picks ([#447](https://github.com/LYKNV/subwave/issues/447)) ([#601](https://github.com/LYKNV/subwave/issues/601)) ([edab50d](https://github.com/LYKNV/subwave/commit/edab50d8895e180cc1618f401c884e495128140b))
* **connect:** discoverable API — explorer, playground, HTTP MCP ([#928](https://github.com/LYKNV/subwave/issues/928)) ([6ac4b0c](https://github.com/LYKNV/subwave/commit/6ac4b0c7a6f1ae861426b3f1ce126e45fb495f13))
* **controller:** fetch Last.fm artist tags directly via the Last.fm API ([#514](https://github.com/LYKNV/subwave/issues/514)) ([ba3696e](https://github.com/LYKNV/subwave/commit/ba3696ed9ad3685de73af2750807272d9a7fc36e))
* **controller:** operator-configurable DJ-agent deadline (default 45s) ([#354](https://github.com/LYKNV/subwave/issues/354)) ([3ee80b8](https://github.com/LYKNV/subwave/commit/3ee80b83b3978ed5ceb4501685af4b33f9bee5da))
* **controller:** persist last 10 raw LLM requests to a rolling log file ([#515](https://github.com/LYKNV/subwave/issues/515)) ([11ccee0](https://github.com/LYKNV/subwave/commit/11ccee0269e1b0f73ed618fca49c8829f391837a))
* **dj:** add ElevenLabs v3 audio-tag hint to the system prompt ([#916](https://github.com/LYKNV/subwave/issues/916)) ([718f5fa](https://github.com/LYKNV/subwave/commit/718f5fafe574d2845294cd23fc33a3ea72b79a3e))
* **dj:** cover 'latest song' + 'more like this' requests ([#428](https://github.com/LYKNV/subwave/issues/428)) ([e418c30](https://github.com/LYKNV/subwave/commit/e418c30d139de41d241cd7b47411ba5b2a7b1edc))
* **dj:** on-air persona handoff at show boundaries ([#762](https://github.com/LYKNV/subwave/issues/762)) ([da3ba9d](https://github.com/LYKNV/subwave/commit/da3ba9da84820335d755f5e0ba9e44c137bf60ae))
* **dj:** per-persona on-air language + language-aware requests ([#350](https://github.com/LYKNV/subwave/issues/350)) ([81cc896](https://github.com/LYKNV/subwave/commit/81cc8965b1aac0744aa893bd5d2bc54cd99f4f3b))
* **dj:** per-persona tone dials (humour, local colour, warmth) + anti-cliché ([#470](https://github.com/LYKNV/subwave/issues/470)) ([1d9e586](https://github.com/LYKNV/subwave/commit/1d9e58611b0f5a118ce7c3ab45bcc517aa0548f5))
* **dj:** per-skill context allow-lists; stop weather dominating DJ patter ([#471](https://github.com/LYKNV/subwave/issues/471)) ([#482](https://github.com/LYKNV/subwave/issues/482)) ([53abe6e](https://github.com/LYKNV/subwave/commit/53abe6e0a24defe2530c3b33760ab4cdff3bad5b))
* **dj:** resolve described track requests via web search (request agent only) ([#425](https://github.com/LYKNV/subwave/issues/425)) ([a9714dd](https://github.com/LYKNV/subwave/commit/a9714ddf7cb70696f6f08bccaecc5c1ef800c477))
* **doctor:** catch weak-model structured-output failures + sharpen DJ Doc UX ([#592](https://github.com/LYKNV/subwave/issues/592)) ([004bbac](https://github.com/LYKNV/subwave/commit/004bbac88e057987c323222235f11f2ed23c4607))
* **doctor:** settings-tuning section + settings-aware DJ Doc review ([#845](https://github.com/LYKNV/subwave/issues/845)) ([3672c44](https://github.com/LYKNV/subwave/commit/3672c44fb1b5955d147453052b9af641d280cc2c))
* **doctor:** stream results, persist last run + header badge, wire review fixes ([#846](https://github.com/LYKNV/subwave/issues/846)) ([baffff0](https://github.com/LYKNV/subwave/commit/baffff0f609c95dd8e56f5f80a5c6d7385cb1a63))
* import operator-supplied jingles and sound effects ([#468](https://github.com/LYKNV/subwave/issues/468)) ([2511119](https://github.com/LYKNV/subwave/commit/25111193a69b0bf23cd0b3c48b25d4a8621bc5bf))
* **jingles:** ship a sound-designed default station ident ([#886](https://github.com/LYKNV/subwave/issues/886)) ([96106da](https://github.com/LYKNV/subwave/commit/96106da44ddaea0fef456f9199e59d69621071b7))
* journey-steered agent picks + admin toggle for sounds-like analysis ([#351](https://github.com/LYKNV/subwave/issues/351)) ([da779c1](https://github.com/LYKNV/subwave/commit/da779c1e1def5be27574217ffac07f76f18795bd))
* **landing:** point bottom CTA to stations page ([#850](https://github.com/LYKNV/subwave/issues/850)) ([8c2f4de](https://github.com/LYKNV/subwave/commit/8c2f4dedc6e5ce024536537bb0b57a8869898944))
* **library:** CLAP capability warning + fix analyzer download hang ([#367](https://github.com/LYKNV/subwave/issues/367)) ([7afdf95](https://github.com/LYKNV/subwave/commit/7afdf95dfb5d10a38db97a1205190db1b336f3f0))
* **library:** manual mood/energy tagging for tracks and albums ([#336](https://github.com/LYKNV/subwave/issues/336)) ([#355](https://github.com/LYKNV/subwave/issues/355)) ([d5b10ac](https://github.com/LYKNV/subwave/commit/d5b10ac64de6377c216d702450c131e45b434c53))
* **library:** manual playlist creation in admin library + Navidrome library-scoping docs ([#704](https://github.com/LYKNV/subwave/issues/704)) ([#953](https://github.com/LYKNV/subwave/issues/953)) ([aa0f046](https://github.com/LYKNV/subwave/commit/aa0f046944a5daa877418b9efea4598153cde68d))
* **library:** never-play blocklist + admin library redesign ([#1008](https://github.com/LYKNV/subwave/issues/1008)) ([f61946a](https://github.com/LYKNV/subwave/commit/f61946a2f6c00cc3e94382007ac7aac7efe6df22))
* **library:** Reset tab — wipe all tagging data and start fresh ([#753](https://github.com/LYKNV/subwave/issues/753)) ([a1eef42](https://github.com/LYKNV/subwave/commit/a1eef428168d50a60c870e46eae6c1174291c154))
* **library:** simplify tagging panel + structured live tagger progress ([#363](https://github.com/LYKNV/subwave/issues/363)) ([8decd10](https://github.com/LYKNV/subwave/commit/8decd10214fdd6876e8e66777b509e316934c9e0))
* **library:** surface tts-heavy setup docs when the acoustic engine is off ([#559](https://github.com/LYKNV/subwave/issues/559)) ([9af92cd](https://github.com/LYKNV/subwave/commit/9af92cde4133dffeaf1aaaf3ba03c689842648e8)), closes [#553](https://github.com/LYKNV/subwave/issues/553)
* **llm:** add configurable per-call max output tokens ([#712](https://github.com/LYKNV/subwave/issues/712)) ([#719](https://github.com/LYKNV/subwave/issues/719)) ([9d72caa](https://github.com/LYKNV/subwave/commit/9d72caa3e640a8d3f977eb371cc1a0ce7a223bf8))
* **llm:** daily token usage cap with graceful degradation ([#599](https://github.com/LYKNV/subwave/issues/599)) ([b9dbeb7](https://github.com/LYKNV/subwave/commit/b9dbeb740753e46afdee09a2329322f4c5478289)), closes [#552](https://github.com/LYKNV/subwave/issues/552)
* **llm:** first-class locca provider + constrained pool picks ([#429](https://github.com/LYKNV/subwave/issues/429)) ([9765425](https://github.com/LYKNV/subwave/commit/9765425f41f1415a7c70964d6a2db7d11c181115))
* **llm:** improve the hourly time-check generator ([#834](https://github.com/LYKNV/subwave/issues/834)) ([387a2ee](https://github.com/LYKNV/subwave/commit/387a2ee66bf24dba955faf78189be1a5e76f5708))
* **llm:** opt-in tool_choice knob for forced-tool servers ([#570](https://github.com/LYKNV/subwave/issues/570)) ([#588](https://github.com/LYKNV/subwave/issues/588)) ([ec1498f](https://github.com/LYKNV/subwave/commit/ec1498fe9daf6fbc98b1859121c7fe1a51603b78))
* **llm:** pool-mode segment path, pick prompt diet, and llm-bench harness ([#961](https://github.com/LYKNV/subwave/issues/961)) ([42ca3ac](https://github.com/LYKNV/subwave/commit/42ca3ac3edb3fc2f27e4658fa9a0d692c6545856))
* **loudness:** ReplayGain-first loudness source + stereo BS.1770 measurement ([#998](https://github.com/LYKNV/subwave/issues/998)) ([#1005](https://github.com/LYKNV/subwave/issues/1005)) ([a50e49f](https://github.com/LYKNV/subwave/commit/a50e49f2baab91860ccb98726d0b93c3b005958f))
* **mcp:** catch the MCP server up with the controller API + on-air sound effects ([#901](https://github.com/LYKNV/subwave/issues/901)) ([f51f665](https://github.com/LYKNV/subwave/commit/f51f665b3ac3eb801ff1f7ccd8bb3492f14f9913))
* **mix:** tail-loudness-shaped exit canvas + boundary-key matching ([#972](https://github.com/LYKNV/subwave/issues/972)) ([69cea9a](https://github.com/LYKNV/subwave/commit/69cea9a70be2ff8bf06f9ae65a96ebe71e57db40))
* **news:** surface buried enumerations as lists in dispatches ([#840](https://github.com/LYKNV/subwave/issues/840)) ([7312e14](https://github.com/LYKNV/subwave/commit/7312e1492d89db357c59c3fd904a236ce76b75f5))
* **observatory:** Library Observatory — data-art view of the DJ's library ([#373](https://github.com/LYKNV/subwave/issues/373)) ([eb194e8](https://github.com/LYKNV/subwave/commit/eb194e80ccf1e95d0dad854c9da73bc2fb6eed96))
* **observatory:** move MAP SIZE and RESET DIAL into the top header ([#1010](https://github.com/LYKNV/subwave/issues/1010)) ([3a9800d](https://github.com/LYKNV/subwave/commit/3a9800d9a1d8ad3dd69034d42c239becbb217809))
* **observatory:** raise node caps for bigger libraries (default 25k, ceiling 100k) ([#869](https://github.com/LYKNV/subwave/issues/869)) ([cc84ffd](https://github.com/LYKNV/subwave/commit/cc84ffd7c89093274e3934b00b700478f14a8d01))
* **observatory:** WebGL galaxy renderer replaces SVG + canvas maps ([#957](https://github.com/LYKNV/subwave/issues/957)) ([35bcda2](https://github.com/LYKNV/subwave/commit/35bcda22b852344cdd81380b1188256061d5c640))
* parallel dual-LLM library tagging + num_ctx debug visibility ([#356](https://github.com/LYKNV/subwave/issues/356)) ([64bb56f](https://github.com/LYKNV/subwave/commit/64bb56fc1daa8ab0755436cab46650791fe236f7))
* **personas:** add Cliff community persona ([#913](https://github.com/LYKNV/subwave/issues/913)) ([7561658](https://github.com/LYKNV/subwave/commit/75616589c9918dc40db733233468b49db015b6eb))
* **personas:** add DJ Rocker community persona ([#893](https://github.com/LYKNV/subwave/issues/893)) ([6e65536](https://github.com/LYKNV/subwave/commit/6e655366052719095f6f267baf90b70d1700debc))
* **personas:** community persona sharing — catalog, install, showcase + submission flow ([#870](https://github.com/LYKNV/subwave/issues/870)) ([689180d](https://github.com/LYKNV/subwave/commit/689180df5f2942bf6f894c791a351949b6b19ca8))
* **personas:** expand persona limits — soul 400→1000, roster 12→24 ([#722](https://github.com/LYKNV/subwave/issues/722)) ([#728](https://github.com/LYKNV/subwave/issues/728)) ([513bfe8](https://github.com/LYKNV/subwave/commit/513bfe8e70e37a42651de7dd6adc9ae46559e7c3))
* **personas:** redesign editor — rotary tone dials, LED voice meter, full-width roster ([#526](https://github.com/LYKNV/subwave/issues/526)) ([ca5ef25](https://github.com/LYKNV/subwave/commit/ca5ef25036d10595e294dda99f5c10cef4a64dcc))
* **personas:** stepped-fader behaviour controls with wider frequency + length ladders ([#922](https://github.com/LYKNV/subwave/issues/922)) ([15736f3](https://github.com/LYKNV/subwave/commit/15736f3a15a9ae49a73f4cb4d8ee50796589a73e))
* **personas:** system-prompt template library with switching + modal editor ([#955](https://github.com/LYKNV/subwave/issues/955)) ([d1f00c3](https://github.com/LYKNV/subwave/commit/d1f00c3dc86b51c340ce9e6a3152caed42457bac))
* **picker:** add per-show strict genre lean (hard-filter the pool, soft fallback) ([#516](https://github.com/LYKNV/subwave/issues/516)) ([b23b8ff](https://github.com/LYKNV/subwave/commit/b23b8ff59cd060afa762f84457facf3dca49b3b6))
* **picker:** surface moods, energy, duration, instrumental to DJ agent candidates ([#605](https://github.com/LYKNV/subwave/issues/605)) ([c263b2d](https://github.com/LYKNV/subwave/commit/c263b2df4f12016272fe66e11951e0c5b0aea88a))
* **picker:** tighten DJ-agent selection criteria and clean its session window ([#608](https://github.com/LYKNV/subwave/issues/608)) ([63d2aff](https://github.com/LYKNV/subwave/commit/63d2aff67861fb5bde74035b1a139dc02f4e271a))
* **player:** deeper live-stream buffering to survive poor cellular coverage ([#1001](https://github.com/LYKNV/subwave/issues/1001)) ([0e42f6f](https://github.com/LYKNV/subwave/commit/0e42f6f9480bdcab44a78f1bd98eb8f368f3b0f8))
* **player:** show cumulative LLM token count by the now-playing time ([#449](https://github.com/LYKNV/subwave/issues/449)) ([b222b79](https://github.com/LYKNV/subwave/commit/b222b7998a5c97944ebabc376af84e76475d458a))
* **player:** show per-track genre/BPM/key/mood strip in now-playing ([#401](https://github.com/LYKNV/subwave/issues/401)) ([bfbe763](https://github.com/LYKNV/subwave/commit/bfbe7632eb2c7f67295773c02e1760cf29882cdd))
* **scrobble:** configurable ListenBrainz API URL for self-hosted scrobbles ([#824](https://github.com/LYKNV/subwave/issues/824)) ([67af402](https://github.com/LYKNV/subwave/commit/67af40257a8ed3bc692fd4cec2138ac3cc76158b))
* **scrobble:** in-admin "Connect to Last.fm", drop the CLI session-key step ([#686](https://github.com/LYKNV/subwave/issues/686)) ([590eb32](https://github.com/LYKNV/subwave/commit/590eb32e21797856c1d86290894d2125c13465bc))
* **search:** Brave Search API as web-search backend ([#623](https://github.com/LYKNV/subwave/issues/623)) ([#984](https://github.com/LYKNV/subwave/issues/984)) ([a82a23c](https://github.com/LYKNV/subwave/commit/a82a23c9fd435cdf2d23ff0a781368c82441e1d0))
* **shows:** anchor shows to Navidrome playlists ([#701](https://github.com/LYKNV/subwave/issues/701)) ([56da727](https://github.com/LYKNV/subwave/commit/56da7276a4b135eefc7133a99d46ef8987d91eae))
* **shows:** guest co-hosts + scripted banter breaks ([#866](https://github.com/LYKNV/subwave/issues/866)) ([78fe272](https://github.com/LYKNV/subwave/commit/78fe2729331b75bf1f3e5b4f4cca2f7c84b5a1e4))
* **shows:** in-page show editor with save/delete confirms ([#694](https://github.com/LYKNV/subwave/issues/694)) ([8d04b1d](https://github.com/LYKNV/subwave/commit/8d04b1d491fe2ba2e29ed6ecfe5736e59ee4007a))
* **shows:** multi-value genre/mood/energy/era show filters ([#929](https://github.com/LYKNV/subwave/issues/929)) ([#951](https://github.com/LYKNV/subwave/issues/951)) ([53e0524](https://github.com/LYKNV/subwave/commit/53e052418eed03c7fe4f9dbba65b996d14056b9a))
* **shows:** Programmes — shows produced as coherent episodes ([#882](https://github.com/LYKNV/subwave/issues/882)) ([e5c0400](https://github.com/LYKNV/subwave/commit/e5c04008cd759b82cbed9796692976ddb21f769f))
* **shows:** steer per-show music by genre, decade, and energy ([#453](https://github.com/LYKNV/subwave/issues/453)) ([422f888](https://github.com/LYKNV/subwave/commit/422f8882930347a8a7913ad3f7ccd03a7a06896c))
* **skills:** add Commute check-in community skill ([#1000](https://github.com/LYKNV/subwave/issues/1000)) ([43c7160](https://github.com/LYKNV/subwave/commit/43c71601939e5ad37cf8e4b2d243e7188c12d6c3))
* **skills:** add DJ Remembrance community skill ([#868](https://github.com/LYKNV/subwave/issues/868)) ([4543e3b](https://github.com/LYKNV/subwave/commit/4543e3be98474c1b2bda21c1f52695fa489698a0))
* **skills:** add Giveaway community skill ([#860](https://github.com/LYKNV/subwave/issues/860)) ([526b432](https://github.com/LYKNV/subwave/commit/526b43276e0f9b3312a5f1a85bdff0a058061a0a))
* **skills:** community skill sharing — submit, ship, install ([#782](https://github.com/LYKNV/subwave/issues/782)) ([aa266be](https://github.com/LYKNV/subwave/commit/aa266bef4aee44a62009450e6f7c48bd31a6c8a4))
* **skills:** create, edit & delete skills from the admin UI ([#695](https://github.com/LYKNV/subwave/issues/695)) ([b5ac6ff](https://github.com/LYKNV/subwave/commit/b5ac6fffa6c741c51dd88787f5a3430c5ddf3574))
* **skills:** make traffic brief region-agnostic and sharper ([#509](https://github.com/LYKNV/subwave/issues/509)) ([7310f5d](https://github.com/LYKNV/subwave/commit/7310f5dbd96b8de67ea800cfc582bdf5e21319b6))
* **skills:** stamp community skill provenance (submitter + dates) ([#847](https://github.com/LYKNV/subwave/issues/847)) ([643d965](https://github.com/LYKNV/subwave/commit/643d965a4d80dd3937d9b7171a26fbdbc195ac33))
* **skills:** tags, filter/sort, and assign-to-DJs from the skill editor ([#1007](https://github.com/LYKNV/subwave/issues/1007)) ([42f6190](https://github.com/LYKNV/subwave/commit/42f61906975ad91196f41a541430bcb7e682f3ae))
* **skills:** unify built-in & custom skills on one loader + services API ([#698](https://github.com/LYKNV/subwave/issues/698)) ([1974d03](https://github.com/LYKNV/subwave/commit/1974d0313aa02aa6b6174e51e0da924b05fdf238))
* **stations:** add 2618 Home Radio to the directory ([#435](https://github.com/LYKNV/subwave/issues/435)) ([753a13e](https://github.com/LYKNV/subwave/commit/753a13e4530fea721bd323e6ef5a79a6709a2b3a))
* **stations:** add Brisflix Radio ([#925](https://github.com/LYKNV/subwave/issues/925)) ([789d600](https://github.com/LYKNV/subwave/commit/789d60048d2742ad7b3f7e24dabcf0a70480a1b5))
* **stations:** add ClippyZone FM ([#733](https://github.com/LYKNV/subwave/issues/733)) ([a84e78e](https://github.com/LYKNV/subwave/commit/a84e78e45eaaeb7803541e49219068e8b73ffd8f))
* **stations:** add ClippyZone FM ([#781](https://github.com/LYKNV/subwave/issues/781)) ([792e03a](https://github.com/LYKNV/subwave/commit/792e03ae16e4f1bb567a810b5f9fd465b23e99b4))
* **stations:** add ClippyZone FM ([#823](https://github.com/LYKNV/subwave/issues/823)) ([a4bc59e](https://github.com/LYKNV/subwave/commit/a4bc59eb17cefb88dcc2705a36935c7889e26c44))
* **stations:** add Klair Radio; flagship genre → various ([#931](https://github.com/LYKNV/subwave/issues/931)) ([48e237d](https://github.com/LYKNV/subwave/commit/48e237d8a193357c7ef88e8a92de239829dc2b28))
* **stations:** add Millennial FM ([#416](https://github.com/LYKNV/subwave/issues/416)) ([17b9c49](https://github.com/LYKNV/subwave/commit/17b9c4996e4b1df39cb54ce4d658725bcb4c79e7))
* **stations:** add Radio Parra Vergara ([#944](https://github.com/LYKNV/subwave/issues/944)) ([5e06195](https://github.com/LYKNV/subwave/commit/5e06195b3b9bf84d3a7fd53d0f7fa6e22076f9af))
* **stations:** add WHIG, The Hig ([#581](https://github.com/LYKNV/subwave/issues/581)) ([b40cfea](https://github.com/LYKNV/subwave/commit/b40cfeaccc00a47b5db7f1305cb0a043c29b3119))
* **stations:** add WHIG, The Hig ([#591](https://github.com/LYKNV/subwave/issues/591)) ([0461d00](https://github.com/LYKNV/subwave/commit/0461d001f3121f9a6867966a00ea55c3f3053569))
* **stats:** scrollable Stats lists + per-container system resources ([#480](https://github.com/LYKNV/subwave/issues/480)) ([8570932](https://github.com/LYKNV/subwave/commit/8570932828c8acfc46f19287ca50ed18071a6e13))
* **stats:** show audience sources (referrers, geo, sessions) on admin Stats ([#456](https://github.com/LYKNV/subwave/issues/456)) ([7e730d1](https://github.com/LYKNV/subwave/commit/7e730d1d2f6b831b90b621bfffbe582dfcf32ae2))
* **stream:** configurable stream outputs — FLAC mount, Opus bitrate, AAC-LC mount ([#699](https://github.com/LYKNV/subwave/issues/699)) ([e821086](https://github.com/LYKNV/subwave/commit/e82108644127830ab38d6f25b809b7b5e9f79a42))
* **tagger:** embedding quality — weighted KNN voting, task prefixes, audio fusion, self-check ([#750](https://github.com/LYKNV/subwave/issues/750)) ([a0ab345](https://github.com/LYKNV/subwave/commit/a0ab345bfac37abe30256cd6288ed81592979dc1))
* **tools:** import track analysis from AudioMuse-AI ([#934](https://github.com/LYKNV/subwave/issues/934)) ([5f81f9a](https://github.com/LYKNV/subwave/commit/5f81f9ae70107ab1cec640d1708644f9b0e542f3))
* **tools:** Jamendo CC-track bulk-pull for demo library ([#465](https://github.com/LYKNV/subwave/issues/465)) ([7b59324](https://github.com/LYKNV/subwave/commit/7b593242b5dee6691fbbb445e9ff576eb6a99818))
* true-audio (CLAP) embeddings + sonic journeys ([#337](https://github.com/LYKNV/subwave/issues/337)) ([6b427f8](https://github.com/LYKNV/subwave/commit/6b427f8251aac5fa0c0f7ee211c91034d51fad8c))
* **tts-heavy:** bake CLAP + Demucs into the published image ([#393](https://github.com/LYKNV/subwave/issues/393)) ([#395](https://github.com/LYKNV/subwave/issues/395)) ([22f3dc8](https://github.com/LYKNV/subwave/commit/22f3dc8f6a7ca256fdfb9b05100e348713478bba))
* **tts-heavy:** GPU opt-in for Chatterbox + Voices manual page & guide ([#562](https://github.com/LYKNV/subwave/issues/562)) ([351a46d](https://github.com/LYKNV/subwave/commit/351a46d01e26ef0b1735971a2311677da34aaeec))
* **tts:** add remote TTS engine for self-hosted HTTP endpoints ([#672](https://github.com/LYKNV/subwave/issues/672)) ([6d4621d](https://github.com/LYKNV/subwave/commit/6d4621dab3ea48817a03e4c3d398cd881ba26816))
* **tts:** add support for kokoro multilingual capabilities ([#759](https://github.com/LYKNV/subwave/issues/759)) ([f123f2a](https://github.com/LYKNV/subwave/commit/f123f2a1081b7364f1d98ebb0f08c43d47be6e6b))
* **tts:** choose which heavy TTS engines load via TTS_HEAVY_ENGINES ([#956](https://github.com/LYKNV/subwave/issues/956)) ([3078d4d](https://github.com/LYKNV/subwave/commit/3078d4dc72ff4deee01fc9603c7f97ca5e93b027))
* **tts:** expose ElevenLabs voice_settings globally under tts.cloud ([#915](https://github.com/LYKNV/subwave/issues/915)) ([5036bc1](https://github.com/LYKNV/subwave/commit/5036bc18bb9f17b56b34705eae13430a622f8f20))
* **tts:** operator-editable speech corrections in admin settings ([#981](https://github.com/LYKNV/subwave/issues/981)) ([c34df62](https://github.com/LYKNV/subwave/commit/c34df6220e6910df697b4d67d30284d1ddeca0a2))
* **tts:** pass persona soul to OpenAI TTS instructions ([#579](https://github.com/LYKNV/subwave/issues/579)) ([#586](https://github.com/LYKNV/subwave/issues/586)) ([0dd5a09](https://github.com/LYKNV/subwave/commit/0dd5a093f4003d28de8168b8009690f09be5141e))
* **tts:** per-engine + per-persona DJ voice gain dial ([#473](https://github.com/LYKNV/subwave/issues/473)) ([bd3b203](https://github.com/LYKNV/subwave/commit/bd3b203be9b7a84c8f9c92725ac9ba15c8b2c264))
* **tts:** per-engine and per-persona speech-speed multipliers ([#639](https://github.com/LYKNV/subwave/issues/639)) ([fd5857a](https://github.com/LYKNV/subwave/commit/fd5857a99c551e4d2d2f3517191ee2a2c93f8d55)), closes [#626](https://github.com/LYKNV/subwave/issues/626)
* **unraid:** all-in-one image + Community Applications one-click install ([#499](https://github.com/LYKNV/subwave/issues/499)) ([29332e0](https://github.com/LYKNV/subwave/commit/29332e0162f9ede50e6754ceb4150138b8d10abb))
* **web:** "Back Pages" footer index + masthead print-craft & disc-morph wordmark ([#852](https://github.com/LYKNV/subwave/issues/852)) ([0f5312a](https://github.com/LYKNV/subwave/commit/0f5312a3c894939b250cd006254bc41e24c8e6ca))
* **web:** app store links on the landing Coda CTA ([#387](https://github.com/LYKNV/subwave/issues/387)) ([d163796](https://github.com/LYKNV/subwave/commit/d163796b1ce9fd1b30393d8be6ab776c55bc2d6c))
* **web:** Booth Buddy DJ-line mascot with station toggle ([#563](https://github.com/LYKNV/subwave/issues/563)) ([385a753](https://github.com/LYKNV/subwave/commit/385a7539c91bbe338bbee508057194a4cdb3dc61))
* **web:** express max track length cap in seconds, not minutes ([#604](https://github.com/LYKNV/subwave/issues/604)) ([c59c4d4](https://github.com/LYKNV/subwave/commit/c59c4d4db5aefacc46579d5c2f793d0dbf196e3b))
* **web:** lite mode to drop blur + animations on low-power devices ([#661](https://github.com/LYKNV/subwave/issues/661)) ([e77b72c](https://github.com/LYKNV/subwave/commit/e77b72c69eaf41338b969861dc13525229a35791))
* **web:** now-playing UX — up-next tease, clock toggle, off-air state, cover placeholder ([#968](https://github.com/LYKNV/subwave/issues/968)) ([6bd35f6](https://github.com/LYKNV/subwave/commit/6bd35f625728d4b4ed3e45884c36f663e7e8533b))
* **web:** public community-skills showcase page + footer link ([#851](https://github.com/LYKNV/subwave/issues/851)) ([b3d71cf](https://github.com/LYKNV/subwave/commit/b3d71cff8cbc42d75195249c32ae21fdccb04453))
* **web:** remember last-used player volume across reloads ([#828](https://github.com/LYKNV/subwave/issues/828)) ([6f5aef2](https://github.com/LYKNV/subwave/commit/6f5aef26a02c9b07e173fc6560d75c5775fe1cd9)), closes [#783](https://github.com/LYKNV/subwave/issues/783)
* **web:** replace slash favicon with the sunburst disc mark ([#880](https://github.com/LYKNV/subwave/issues/880)) ([ab8f149](https://github.com/LYKNV/subwave/commit/ab8f149893daf0b7a5771d30d240984f0fa119dd))
* **web:** resolve GA Measurement ID at runtime (no rebuild needed) ([#932](https://github.com/LYKNV/subwave/issues/932)) ([48d9b9b](https://github.com/LYKNV/subwave/commit/48d9b9b9cd52e022a697ee9f656bcfd6f789c431))
* **web:** show app version in admin console footer ([#596](https://github.com/LYKNV/subwave/issues/596)) ([ca360cd](https://github.com/LYKNV/subwave/commit/ca360cdc68af902be9dea31fd95e4a93d28c8704))
* **web:** showcase the Library Observatory on the landing page ([#385](https://github.com/LYKNV/subwave/issues/385)) ([f9e5f2c](https://github.com/LYKNV/subwave/commit/f9e5f2c7f26b1a1d9ba4ca697ee466a09a85cae2))
* **web:** station health strip on the admin dash header ([#388](https://github.com/LYKNV/subwave/issues/388)) ([de5b071](https://github.com/LYKNV/subwave/commit/de5b071a39c4969144ee5a21a0e20a6cc78382c2))
* **web:** station tabs on the landing demo player ([#342](https://github.com/LYKNV/subwave/issues/342)) ([defdecc](https://github.com/LYKNV/subwave/commit/defdeccd4e8fd5144d6cfe55d875d58bddc8d445))
* **web:** visual show editor with genre, persona & theme pickers ([#674](https://github.com/LYKNV/subwave/issues/674)) ([1d33de6](https://github.com/LYKNV/subwave/commit/1d33de6242e90ce78792ed6094726198be731d10))


### Bug Fixes

* address develop→main review findings (leaked reasoning, ElevenLabs, AudioMuse importer) ([#954](https://github.com/LYKNV/subwave/issues/954)) ([bbf1be5](https://github.com/LYKNV/subwave/commit/bbf1be51355fc5708eb936065a0083e3c01c12c5))
* **admin/library:** disable Re-analyse acoustics when no analysis engine is running ([#767](https://github.com/LYKNV/subwave/issues/767)) ([2cc6b1f](https://github.com/LYKNV/subwave/commit/2cc6b1f4908746ab43b2adc2d27bf1477bd38ca8))
* **admin/library:** hide Backfill buttons on a virgin library, drop the Analyze label flip ([#756](https://github.com/LYKNV/subwave/issues/756)) ([6b70475](https://github.com/LYKNV/subwave/commit/6b7047525b82cec2dc3251e9f7ff7212397d3354))
* **admin/library:** vocal-activity modal checkboxes appear immediately on enable ([#755](https://github.com/LYKNV/subwave/issues/755)) ([992feed](https://github.com/LYKNV/subwave/commit/992feed3cc61d1bb694609534a2d419933a94213))
* **admin/shows:** alphabetize genre lean autocomplete options ([#770](https://github.com/LYKNV/subwave/issues/770)) ([9a02313](https://github.com/LYKNV/subwave/commit/9a023135bc31186fe9ceb06c92869499052597b9))
* **admin/shows:** touch-safe schedule painting — long-press to paint, tap to toggle, swipe scrolls ([#757](https://github.com/LYKNV/subwave/issues/757)) ([8ec26bf](https://github.com/LYKNV/subwave/commit/8ec26bf70045960ae1d0fdfae207aa1478fc502d))
* **admin/tagger:** make LLM batch-size setting actually persist (supersedes [#778](https://github.com/LYKNV/subwave/issues/778)) ([a6957fc](https://github.com/LYKNV/subwave/commit/a6957fc04b45086c1bb63b038dd0ff1400950eca))
* **admin:** de-glitch shows add/edit modal + frosted backdrop ([#519](https://github.com/LYKNV/subwave/issues/519)) ([36f947c](https://github.com/LYKNV/subwave/commit/36f947c0a281c268a87656284ce080903b443361))
* **admin:** make "Custom voice id…" selectable for cloud TTS voices ([#437](https://github.com/LYKNV/subwave/issues/437)) ([a9618c1](https://github.com/LYKNV/subwave/commit/a9618c150f8d8b0e7444609b0c81e6e8df324d89))
* **admin:** make AI show/persona generators tolerant of partial model output ([#556](https://github.com/LYKNV/subwave/issues/556)) ([29bc697](https://github.com/LYKNV/subwave/commit/29bc6973ec3812eb897be25951120f4fd0cbfcb4))
* **admin:** reflow theme buttons + reorder archive cards ([#654](https://github.com/LYKNV/subwave/issues/654)) ([5238a23](https://github.com/LYKNV/subwave/commit/5238a23cc084e2b1407c7c69563b4da3831919a4))
* **admin:** remove failing/warning count badge from DJ Doc header link ([#1011](https://github.com/LYKNV/subwave/issues/1011)) ([d0b6204](https://github.com/LYKNV/subwave/commit/d0b620412b5b3957e59eb508bc75ef76f18b7563))
* **admin:** restore Save button when editing the system prompt ([#724](https://github.com/LYKNV/subwave/issues/724)) ([#729](https://github.com/LYKNV/subwave/issues/729)) ([d483318](https://github.com/LYKNV/subwave/commit/d4833186a2fb62e7a07dbc8f24f6af6465455187))
* **admin:** stop /debug polling from stacking requests and starving the controller ([#825](https://github.com/LYKNV/subwave/issues/825)) ([25345ab](https://github.com/LYKNV/subwave/commit/25345ab41c31b7b2aa4aaf2bed68371ec29fae20))
* **admin:** stop long festival descriptions from pushing controls off-card ([#898](https://github.com/LYKNV/subwave/issues/898)) ([#900](https://github.com/LYKNV/subwave/issues/900)) ([6f79fbb](https://github.com/LYKNV/subwave/commit/6f79fbb7aad906ad7b4c38bdcc0c9237ba4ed277))
* **admin:** stop native basic-auth popup on skill edit ([#709](https://github.com/LYKNV/subwave/issues/709)) ([78b7bdc](https://github.com/LYKNV/subwave/commit/78b7bdc4bee067c286eb6eee1614282cba59b624))
* **aio:** install python3-dev for the diffq sdist build in heavy AIO image ([#744](https://github.com/LYKNV/subwave/issues/744)) ([a31b2b7](https://github.com/LYKNV/subwave/commit/a31b2b7620f9b1752df2d98daf3cc643db8e28cb))
* **aio:** warn at boot when /var/sub-wave isn't mounted ([#902](https://github.com/LYKNV/subwave/issues/902)) ([#921](https://github.com/LYKNV/subwave/issues/921)) ([d304549](https://github.com/LYKNV/subwave/commit/d304549a40405ae6a6113c41e0aa416ccc6ef418))
* **analyzer:** lend gcc to the diffq sdist build in heavy images ([#737](https://github.com/LYKNV/subwave/issues/737)) ([51dc493](https://github.com/LYKNV/subwave/commit/51dc493ea82df2519f57b90303d56bf23aa4639e))
* **analyzer:** local backend reports real CLAP/Demucs capability + AIO-aware doctor hints ([#983](https://github.com/LYKNV/subwave/issues/983)) ([f6ec6ad](https://github.com/LYKNV/subwave/commit/f6ec6ad71b676261fd8d1240983fe5efc2fe1bb3))
* **analyzer:** pass HF_TOKEN through to the analyzer sidecar ([#739](https://github.com/LYKNV/subwave/issues/739)) ([1bc8983](https://github.com/LYKNV/subwave/commit/1bc89831908799976a84b651a17e8bbda38072d9))
* **analyzer:** raise worker stdout line limit so /embed-text batches don't 500 ([#1002](https://github.com/LYKNV/subwave/issues/1002)) ([fab3301](https://github.com/LYKNV/subwave/commit/fab330100143115759e00bb76ee8c466c7f186bc)), closes [#996](https://github.com/LYKNV/subwave/issues/996)
* **app:** clamp DJ thinking line so long scripts don't overlap the waveform ([#668](https://github.com/LYKNV/subwave/issues/668)) ([0cf58fa](https://github.com/LYKNV/subwave/commit/0cf58faee5c58be840dce154352707159ea95820))
* **app:** consent before silent https→http downgrade in onboarding ([#472](https://github.com/LYKNV/subwave/issues/472)) ([01cfaea](https://github.com/LYKNV/subwave/commit/01cfaea65886b01109b1cb008687f8a863f3fb6b))
* **app:** pause + drop stream when iOS output device disappears ([#992](https://github.com/LYKNV/subwave/issues/992)) ([#1003](https://github.com/LYKNV/subwave/issues/1003)) ([f47fafb](https://github.com/LYKNV/subwave/commit/f47fafb8f39ccc79baaea83abcd3c13bc8753c55))
* **app:** remove Android Auto declaration rejected by Google Play ([#477](https://github.com/LYKNV/subwave/issues/477)) ([468ff36](https://github.com/LYKNV/subwave/commit/468ff3634963ce6d97c1174378997d9e8d65ad7d))
* **app:** replace gorhom sheet + drop gesture-handler stack to fix Android dead-touch (New Arch) ([#561](https://github.com/LYKNV/subwave/issues/561)) ([b2d0a4a](https://github.com/LYKNV/subwave/commit/b2d0a4ae5ce57e834262b06967977f99f560f670))
* **app:** request drawer hangs on "Closing…" after the first request ([#542](https://github.com/LYKNV/subwave/issues/542)) ([0f7e22d](https://github.com/LYKNV/subwave/commit/0f7e22d077607999a157bc7abf43ff88ce566d69))
* **app:** send URL basic-auth as a header so iOS AVPlayer can stream ([#764](https://github.com/LYKNV/subwave/issues/764)) ([#772](https://github.com/LYKNV/subwave/issues/772)) ([68c3c3a](https://github.com/LYKNV/subwave/commit/68c3c3a5f709d7a2420b9c0de6d52f4a5c263814))
* **auth:** harden admin auth with timing-safe comparison and brute-force lockoutFix/admin auth timing bruteforce ([#491](https://github.com/LYKNV/subwave/issues/491)) ([83195e5](https://github.com/LYKNV/subwave/commit/83195e583044c7988ec54d24e456efb4010f9f13))
* **auth:** reset brute-force counter after lockout window expires ([#517](https://github.com/LYKNV/subwave/issues/517)) ([55f17af](https://github.com/LYKNV/subwave/commit/55f17af46fe6805282434bcb33a6863a58abc8ca))
* **backup:** restore custom-theme media before validating settings ([#917](https://github.com/LYKNV/subwave/issues/917)) ([#920](https://github.com/LYKNV/subwave/issues/920)) ([2897fcd](https://github.com/LYKNV/subwave/commit/2897fcdf01853029c0b278226c81e01ef99d9565))
* **backup:** restore from state/ to bypass proxy upload caps ([#612](https://github.com/LYKNV/subwave/issues/612)) ([#633](https://github.com/LYKNV/subwave/issues/633)) ([8ad7862](https://github.com/LYKNV/subwave/commit/8ad7862c1bc82f0892e1b58d780e2dd4f2e9eda9))
* **broadcast+aio:** run liquidsoap as root so it can write state after 2.4.4 uid change ([#821](https://github.com/LYKNV/subwave/issues/821)) ([56c13c7](https://github.com/LYKNV/subwave/commit/56c13c722df8afe00900ba30207c4c2e6438f4c8))
* **broadcast:** bump MP3 stream 128 → 192 kbps ([#406](https://github.com/LYKNV/subwave/issues/406)) ([6b2260a](https://github.com/LYKNV/subwave/commit/6b2260a306cc44d2fdbd9ed7776a64f8cbd69259))
* **broadcast:** enforce max-track-length as a hard on-air cut ([#447](https://github.com/LYKNV/subwave/issues/447)) ([#636](https://github.com/LYKNV/subwave/issues/636)) ([01e1606](https://github.com/LYKNV/subwave/commit/01e160668f3d81eaee12137b74af1078a2e63519))
* **broadcast:** fire transition stingers at the crossfade, bound SFX durations ([#839](https://github.com/LYKNV/subwave/issues/839)) ([f80e55e](https://github.com/LYKNV/subwave/commit/f80e55e05a60dcf46ca178cd5600c3b979c34fad))
* **broadcast:** fix crossfade buffer/fade mismatch causing gaps ([b0eb5b7](https://github.com/LYKNV/subwave/commit/b0eb5b7fe9af05a7813ef346bdb191123f5b930b))
* **broadcast:** fix crossfade buffer/fade mismatch causing gaps ([579915a](https://github.com/LYKNV/subwave/commit/579915a3d8f88e184f3667d0b95b1f7f382de9ea))
* **broadcast:** forward-looking DJ links so a request can't make the DJ name a stale track ([#675](https://github.com/LYKNV/subwave/issues/675)) ([1f9d38d](https://github.com/LYKNV/subwave/commit/1f9d38d8b2f85e98b5eab07d27297dc7acb8da9a))
* **broadcast:** keep jingle stingers from talking over the DJ + allow disabling jingles ([#997](https://github.com/LYKNV/subwave/issues/997)) ([#1004](https://github.com/LYKNV/subwave/issues/1004)) ([eee300b](https://github.com/LYKNV/subwave/commit/eee300b29e147ba7449c6fe815b2ddbde54c70cc))
* **broadcast:** Liquidsoap 2.4.5 — un-stall DJ transition effects + boot log rotation ([#844](https://github.com/LYKNV/subwave/issues/844)) ([3cbfa21](https://github.com/LYKNV/subwave/commit/3cbfa21119c8ac5e934bf94686c832607e85dbb7))
* **broadcast:** micro edge fades on DJ voice clips to kill boundary clicks ([#830](https://github.com/LYKNV/subwave/issues/830)) ([9f6737c](https://github.com/LYKNV/subwave/commit/9f6737cbf2503169516614ad8003c6da531cf4de))
* **broadcast:** remove blank.skip that busy-loops at 100% CPU on empty library ([#660](https://github.com/LYKNV/subwave/issues/660)) ([#665](https://github.com/LYKNV/subwave/issues/665)) ([643248f](https://github.com/LYKNV/subwave/commit/643248f2d307799c316b0eeb29984aefbfe5ca9e))
* **broadcast:** rotate jingles on the raw music source so they keep firing ([#687](https://github.com/LYKNV/subwave/issues/687)) ([f1372ba](https://github.com/LYKNV/subwave/commit/f1372ba1daf55b8a6f657182b2bf63ca5ae1a48b))
* **broadcast:** soften heavy voice duck from 15% to 22% ([#382](https://github.com/LYKNV/subwave/issues/382)) ([fcb025b](https://github.com/LYKNV/subwave/commit/fcb025b0ebfc0cbc95368d1dcf4825ae98943a52))
* **broadcast:** stop hourly archive when station is taken off air ([#768](https://github.com/LYKNV/subwave/issues/768)) ([aa414dd](https://github.com/LYKNV/subwave/commit/aa414ddfe7ce8db2f551ce23e22db6cbf93172e7))
* **broadcast:** stop shipping mis-targeted DJ adaptive-blend length ([#749](https://github.com/LYKNV/subwave/issues/749)) ([#760](https://github.com/LYKNV/subwave/issues/760)) ([3347249](https://github.com/LYKNV/subwave/commit/334724915bd2b56301d37903bc7d74578c36bc86))
* **broadcast:** un-silence DJ voice clips — fade.out on request.queue kills the whole clip ([#837](https://github.com/LYKNV/subwave/issues/837)) ([d49e0d7](https://github.com/LYKNV/subwave/commit/d49e0d7d6efd1bd329a27702ac864ce116ae18e8))
* **build:** copy controller/.npmrc into image so npm install gets legacy-peer-deps ([#678](https://github.com/LYKNV/subwave/issues/678)) ([c16516c](https://github.com/LYKNV/subwave/commit/c16516c268d86dd1c9f97c5f28b212a294c6f368))
* **build:** publish subwave-aio amd64-only (arm64 webbuild fails under QEMU) ([#503](https://github.com/LYKNV/subwave/issues/503)) ([e06d7ff](https://github.com/LYKNV/subwave/commit/e06d7ff65f17741862fbf9eb1f6f4725b5e0c87e))
* **build:** stamp deployed version into images so the admin footer isn't a release behind ([#663](https://github.com/LYKNV/subwave/issues/663)) ([854f82e](https://github.com/LYKNV/subwave/commit/854f82e017d276d79f868f712cc4ac483c6d2f5b))
* **caddy:** route /listen.pls + /listen.m3u to the controller ([#689](https://github.com/LYKNV/subwave/issues/689)) ([d739d95](https://github.com/LYKNV/subwave/commit/d739d953c86bd8d6e6e96c819c33c29fe805cd3a))
* **controller/library:** stop post-analysis UI slowdown from fat acoustic rows ([#723](https://github.com/LYKNV/subwave/issues/723)) ([#771](https://github.com/LYKNV/subwave/issues/771)) ([0b94f41](https://github.com/LYKNV/subwave/commit/0b94f41729f8b990e8ee157dcf6908ff7c460fa2))
* **controller/llm:** route locca picker through done-tool, not native ([#467](https://github.com/LYKNV/subwave/issues/467)) ([1a6ec25](https://github.com/LYKNV/subwave/commit/1a6ec25e907543bab361c88fe50c72cfe7e8670e))
* **controller/llm:** route openai-compatible picker through done-tool, not native ([#474](https://github.com/LYKNV/subwave/issues/474)) ([353c974](https://github.com/LYKNV/subwave/commit/353c9742232bb6e4e2971607659a4b97bedee195))
* **controller:** checkpoint the library DB WAL and shut down cleanly ([#829](https://github.com/LYKNV/subwave/issues/829)) ([fae6855](https://github.com/LYKNV/subwave/commit/fae6855d4ec06d51c6d4644ac5ec942be39bd8cc)), closes [#786](https://github.com/LYKNV/subwave/issues/786)
* **controller:** enforce agent deadline + circuit-break failing agent picks ([#352](https://github.com/LYKNV/subwave/issues/352)) ([5553606](https://github.com/LYKNV/subwave/commit/5553606d9c0fa7d285a3c52a4e2c625ed0756e2a))
* **controller:** fuzzy-resolve requested artists + log near-misses ([#403](https://github.com/LYKNV/subwave/issues/403)) ([6cacc02](https://github.com/LYKNV/subwave/commit/6cacc029ccfb23cf01f41995d35d67f9b3912ef7))
* **controller:** persist curiosity dedup across restarts ([#577](https://github.com/LYKNV/subwave/issues/577)) ([#587](https://github.com/LYKNV/subwave/issues/587)) ([a95c987](https://github.com/LYKNV/subwave/commit/a95c9871ab74c21f7d8a8cc686afd8ef01533eee))
* **deploy:** stop health-check error scan false-failing on benign log noise ([#838](https://github.com/LYKNV/subwave/issues/838)) ([b647840](https://github.com/LYKNV/subwave/commit/b64784033b6dc05f70bcfce18ba0ab2c2405b9b6))
* **dj-agent:** don't record a phantom pick when the dedup guard drops a track ([#548](https://github.com/LYKNV/subwave/issues/548)) ([a8c8f44](https://github.com/LYKNV/subwave/commit/a8c8f44027b35134ecfcd43b0d9b243fc131c6e9))
* **dj-agent:** gate mid-run link guidance on wantLink ([#610](https://github.com/LYKNV/subwave/issues/610)) ([c5643bf](https://github.com/LYKNV/subwave/commit/c5643bf8d52defb353643e8da16127ce537aa929))
* **dj-agent:** salvage unknown-id picks and make empty tool results teach ([#763](https://github.com/LYKNV/subwave/issues/763)) ([c2e4260](https://github.com/LYKNV/subwave/commit/c2e4260155984522e101a44bac1eac952097ac54))
* **dj-agent:** stop coaching transition effects the persona can't use ([#754](https://github.com/LYKNV/subwave/issues/754)) ([69c80ff](https://github.com/LYKNV/subwave/commit/69c80ff10b4c82017d02b9cf460536c666bfce11))
* **dj:** apply persona language to agent segments + cloud TTS ([#558](https://github.com/LYKNV/subwave/issues/558)) ([#564](https://github.com/LYKNV/subwave/issues/564)) ([04f3678](https://github.com/LYKNV/subwave/commit/04f36787569070005a4a3445f5c62f505697238d))
* **dj:** hemisphere-correct season + surface day/night, so the DJ stops describing summer heat in a southern-hemisphere winter ([#765](https://github.com/LYKNV/subwave/issues/765)) ([1b1b35a](https://github.com/LYKNV/subwave/commit/1b1b35a0f36e98ba0eccca19a8e00585cb55d6b6))
* **dj:** let a show's pinned mood and energy override the daypart wind-down ([#899](https://github.com/LYKNV/subwave/issues/899)) ([a438fd0](https://github.com/LYKNV/subwave/commit/a438fd0f4cb9288a66a71bfa9d2927f54b20156b))
* **dj:** locale-aware spoken clock + deterministic hourly time phrase ([#1016](https://github.com/LYKNV/subwave/issues/1016)) ([121dada](https://github.com/LYKNV/subwave/commit/121dadae9ad2e462a7b1694acf7434a9002914cf))
* **dj:** pick under the incoming show's rules near a show boundary ([#836](https://github.com/LYKNV/subwave/issues/836)) ([6384b76](https://github.com/LYKNV/subwave/commit/6384b766039e5df43e6b17f408cab94795f80a24))
* **dj:** slim the programme-plan capability menu to one line per kind ([#950](https://github.com/LYKNV/subwave/issues/950)) ([26fb586](https://github.com/LYKNV/subwave/commit/26fb58642fe96b7f7e977b6358f210e069f38140))
* **dj:** stop time call-outs airing minutes stale ([#872](https://github.com/LYKNV/subwave/issues/872)) ([f15c56d](https://github.com/LYKNV/subwave/commit/f15c56d84ad4c1459b7c0bf72f9faba3df59eb42))
* **doctor:** analyzer heavy-image hints cover non-compose installs ([#974](https://github.com/LYKNV/subwave/issues/974)) ([ae6d476](https://github.com/LYKNV/subwave/commit/ae6d476304f77652de4475b0fd7bf60e36eb1f06))
* **embedding:** handle provider-prefixed model names in dim lookup ([ba5ae3e](https://github.com/LYKNV/subwave/commit/ba5ae3e22507a3f4d537fab219c12b059ae7667e))
* **embedding:** honour EMBEDDING_API_KEY across providers (completes [#535](https://github.com/LYKNV/subwave/issues/535)) ([#549](https://github.com/LYKNV/subwave/issues/549)) ([676c9f6](https://github.com/LYKNV/subwave/commit/676c9f6e2f1fb2dc4a0218957211d1991e52eb04))
* **embeddings:** make embedding-model changes actually work (fresh + populated) ([#721](https://github.com/LYKNV/subwave/issues/721)) ([aadd954](https://github.com/LYKNV/subwave/commit/aadd954479d6fc2f820f9d4fe5d5f97539778575))
* **embeddings:** support OpenRouter as an embedding provider ([#522](https://github.com/LYKNV/subwave/issues/522)) ([#523](https://github.com/LYKNV/subwave/issues/523)) ([403b3b8](https://github.com/LYKNV/subwave/commit/403b3b89969e2bc56f1b632e97f84c8b04f6991b))
* **embedding:** stop chat-provider switch from silently breaking vector search ([#607](https://github.com/LYKNV/subwave/issues/607)) ([b382e18](https://github.com/LYKNV/subwave/commit/b382e18b7bc4b6786f0712826a0b3e03d276ad1b))
* **landing:** a11y + polish touchups across the broadsheet ([#883](https://github.com/LYKNV/subwave/issues/883)) ([95875d0](https://github.com/LYKNV/subwave/commit/95875d0abbd35b3037e475f9d6ad400641f18a65))
* **library:** make Last.fm tag enrichment reachable from every path ([#541](https://github.com/LYKNV/subwave/issues/541)) ([1b2e0d4](https://github.com/LYKNV/subwave/commit/1b2e0d4be6d6a9e2497b921c688f71f0b461d817))
* **library:** show real tag status in Recently-added & Search tabs ([#448](https://github.com/LYKNV/subwave/issues/448)) ([a9b313b](https://github.com/LYKNV/subwave/commit/a9b313b5cba86b96d56e12089e7cc05e9bb42402))
* **listeners:** count distinct listeners behind a reverse proxy ([#445](https://github.com/LYKNV/subwave/issues/445)) ([a16f641](https://github.com/LYKNV/subwave/commit/a16f641c026d773112b8ca23cf04e9274432a1cf))
* **listeners:** dedupe Safari's double Icecast connection in counts + admin table ([#434](https://github.com/LYKNV/subwave/issues/434)) ([24e0d49](https://github.com/LYKNV/subwave/commit/24e0d494f2f74aa26b87ea7aa53592103ab0f075))
* **llm:** detect rate limit 429s and honor Retry-After for failover ([#751](https://github.com/LYKNV/subwave/issues/751)) ([87c9027](https://github.com/LYKNV/subwave/commit/87c9027582e8078df4b641fad2d1e2680929b708))
* **llm:** fail over on quota/usage-limit/auth errors, not just host-down ([#438](https://github.com/LYKNV/subwave/issues/438)) ([#440](https://github.com/LYKNV/subwave/issues/440)) ([beb4e95](https://github.com/LYKNV/subwave/commit/beb4e95ddf3dea183f3a1f391d73f8cfe76a9070))
* **llm:** fail over to fallback model on upstream-overload errors ([#671](https://github.com/LYKNV/subwave/issues/671)) ([#684](https://github.com/LYKNV/subwave/issues/684)) ([40d57ae](https://github.com/LYKNV/subwave/commit/40d57ae500faa1e519bf0c262188a2ac8e7ce6d8))
* **llm:** force parallel_tool_calls:false on openai-compatible tool requests ([#945](https://github.com/LYKNV/subwave/issues/945)) ([c2adb64](https://github.com/LYKNV/subwave/commit/c2adb64e05eb8149956a123c131a456e04192ecf)), closes [#940](https://github.com/LYKNV/subwave/issues/940)
* **llm:** forward repeat_penalty + reasoning_format on the openai-compatible path ([#918](https://github.com/LYKNV/subwave/issues/918)) ([adc1ede](https://github.com/LYKNV/subwave/commit/adc1edeeb314308c0de3d89f607744999190f872))
* **llm:** harden the djAgentRequest call ([#833](https://github.com/LYKNV/subwave/issues/833)) ([4c300ec](https://github.com/LYKNV/subwave/commit/4c300ec151da3ddbf25a98cae0fc5be823c9d70f))
* **llm:** honour forceNoThink on openai-compatible/locca picker legs ([#935](https://github.com/LYKNV/subwave/issues/935)) ([42f78ee](https://github.com/LYKNV/subwave/commit/42f78eefdcf7289b562af384bb7c5e6b40967c31))
* **llm:** keep the DJ from failing loud when gemma ignores the forced done tool ([#555](https://github.com/LYKNV/subwave/issues/555)) ([#560](https://github.com/LYKNV/subwave/issues/560)) ([135ef0d](https://github.com/LYKNV/subwave/commit/135ef0d54c3ef53f3790f9496ecdb7f9cc11920e))
* **llm:** namespace inline API keys per-provider ([#657](https://github.com/LYKNV/subwave/issues/657)) ([#664](https://github.com/LYKNV/subwave/issues/664)) ([932f3a6](https://github.com/LYKNV/subwave/commit/932f3a6d26f16d0ad6cb79530a72bae6653902b5))
* **llm:** never air truncated reasoning (handoff spoke its own instructions) ([#949](https://github.com/LYKNV/subwave/issues/949)) ([0ddc54f](https://github.com/LYKNV/subwave/commit/0ddc54fc7eeb7fdea8135fcb920649a4c5ffc22c))
* **llm:** prompt-layer fixes — invented weather, scriptLength on agent paths, homelab/commute framing ([#785](https://github.com/LYKNV/subwave/issues/785)) ([07543f5](https://github.com/LYKNV/subwave/commit/07543f50766791d86ea8c42334c34bc1c7b6a8db))
* **llm:** raise connection-test token budget above OpenAI Responses API minimum ([#1015](https://github.com/LYKNV/subwave/issues/1015)) ([b1da909](https://github.com/LYKNV/subwave/commit/b1da9097e56a07aa015596ee5ca13b304b35f6ca))
* **llm:** reliable DJ picker across providers — native-first output, thinking-safe forced tools, SDK bump ([#407](https://github.com/LYKNV/subwave/issues/407)) ([fcf94b0](https://github.com/LYKNV/subwave/commit/fcf94b0100538d69d365fb5d2d59ceeba9a89d78))
* **llm:** resolve GLM structured-output and thinking-suppression failures ([#923](https://github.com/LYKNV/subwave/issues/923)) ([1434e91](https://github.com/LYKNV/subwave/commit/1434e91acc911fb2c2829df0a29e3e7107dae6ca))
* **llm:** stop runaway &lt;/think&gt; repetition loops leaking to air ([#914](https://github.com/LYKNV/subwave/issues/914)) ([4ff4b54](https://github.com/LYKNV/subwave/commit/4ff4b54deebdaa503a9633c6d90d742bc54c4576))
* **onboarding:** redirect unconfigured player to wizard, Punjab default + coords, drop jingles ([#498](https://github.com/LYKNV/subwave/issues/498)) ([1fde280](https://github.com/LYKNV/subwave/commit/1fde2807eda4697fe1614e1c18bc48d6b19745fa))
* **onboarding:** surface errors and bound timeouts on the Test buttons ([#682](https://github.com/LYKNV/subwave/issues/682)) ([#683](https://github.com/LYKNV/subwave/issues/683)) ([66590ba](https://github.com/LYKNV/subwave/commit/66590baab9e32447fae254a52b9a7ac5fc21c472))
* **ops:** harden installer, CI, and docker runtime ([#788](https://github.com/LYKNV/subwave/issues/788)) ([b27dc3e](https://github.com/LYKNV/subwave/commit/b27dc3e0351d16720987ce6c2bedc4790c0a24fe))
* **personas:** give feedback when adding a persona ([#518](https://github.com/LYKNV/subwave/issues/518)) ([cc899c0](https://github.com/LYKNV/subwave/commit/cc899c0075f24119ce4c456743f136751ffedd54))
* **personas:** mark "on air" by the effective persona, not the default ([#540](https://github.com/LYKNV/subwave/issues/540)) ([175751b](https://github.com/LYKNV/subwave/commit/175751b4ca74ab4a51ae851db70e6a872f0876eb))
* **picker:** gate embedding-backed discovery tools when the index is empty ([8f16d20](https://github.com/LYKNV/subwave/commit/8f16d202a93aa8debc162d60402257d4112972ee))
* **picker:** guard artist/title requests to searchLibrary; disambiguate identifyRequestedTrack from searchByLyrics ([#631](https://github.com/LYKNV/subwave/issues/631)) ([5237a0b](https://github.com/LYKNV/subwave/commit/5237a0b5676f8eb1ae47fa9c4cf88624dbe3f61f))
* **picker:** join library moods/analysis for Subsonic-sourced candidates, treat ID3 bpm 0 as unknown ([#871](https://github.com/LYKNV/subwave/issues/871)) ([dc6252b](https://github.com/LYKNV/subwave/commit/dc6252b7bbb13ab52681baa59be6e0be8ae8f406)), closes [#862](https://github.com/LYKNV/subwave/issues/862)
* **picker:** let agent identify songs from pasted lyrics via web search ([#617](https://github.com/LYKNV/subwave/issues/617)) ([bb3b4e6](https://github.com/LYKNV/subwave/commit/bb3b4e6cd477d528bdad6b09d253d710d6971103))
* **picker:** non-relaxable count-based no-repeat guard + recent-plays dedup ([#638](https://github.com/LYKNV/subwave/issues/638)) ([1533c23](https://github.com/LYKNV/subwave/commit/1533c237de66399f8ad7621190f1e70443558c7e))
* **picker:** skip mood-name playlist match when a show pins playlists ([#718](https://github.com/LYKNV/subwave/issues/718)) ([9cda732](https://github.com/LYKNV/subwave/commit/9cda732ab864f2282eff2ddc930c368d07f10a15))
* **picker:** stop artist/track over-repetition from three sources ([#603](https://github.com/LYKNV/subwave/issues/603)) ([5fbd1cf](https://github.com/LYKNV/subwave/commit/5fbd1cfa0e8a4e29e6fe55490b8abe689910f355))
* **picker:** tolerate small-model id transcription slips ([#939](https://github.com/LYKNV/subwave/issues/939)) ([#948](https://github.com/LYKNV/subwave/issues/948)) ([233fea6](https://github.com/LYKNV/subwave/commit/233fea668ac940c58cc20e7a87be66dd09090897))
* **player:** tie the DJ thinking line to the on-air track ([#546](https://github.com/LYKNV/subwave/issues/546)) ([#597](https://github.com/LYKNV/subwave/issues/597)) ([03478d3](https://github.com/LYKNV/subwave/commit/03478d3dca53682411e51803846d59e6d1f2a78b))
* **queue:** deduplicate track pushes to prevent stacking ([#538](https://github.com/LYKNV/subwave/issues/538)) ([43d3893](https://github.com/LYKNV/subwave/commit/43d3893d8cf41ade9d7d0a1cd8f493452575753e))
* **queue:** replace _autoMisses heuristic with Liquidsoap telnet sync… ([#637](https://github.com/LYKNV/subwave/issues/637)) ([b0e3936](https://github.com/LYKNV/subwave/commit/b0e39364fc788e07a1bc5f083ce4057f9be8e09a))
* **release:** bump embedded CLI_VERSION via release-please generic updater ([#400](https://github.com/LYKNV/subwave/issues/400)) ([0a5c51e](https://github.com/LYKNV/subwave/commit/0a5c51e8419505bf1677b983afa76867665ce47d))
* **request:** dedup concurrent listener requests for the same track ([#619](https://github.com/LYKNV/subwave/issues/619)) ([#635](https://github.com/LYKNV/subwave/issues/635)) ([9c2abe4](https://github.com/LYKNV/subwave/commit/9c2abe4bf8e75774955338e8639f7075ace498d7))
* **requests:** honest intro/ack when requested artist isn't in the library ([#455](https://github.com/LYKNV/subwave/issues/455)) ([1c9b188](https://github.com/LYKNV/subwave/commit/1c9b188c87a8099c24aa39bd9aa96af30134101a))
* **requests:** sanitize listener request text against prompt injection ([#446](https://github.com/LYKNV/subwave/issues/446)) ([6a57792](https://github.com/LYKNV/subwave/commit/6a577923f4e3286ceb2063d0cc8ddacdb958fb76))
* **scheduler:** respect active show genre/era/energy on the fallback playlist ([#629](https://github.com/LYKNV/subwave/issues/629)) ([#634](https://github.com/LYKNV/subwave/issues/634)) ([0d3efae](https://github.com/LYKNV/subwave/commit/0d3efaecbdd100cb8f3486a2734c9528f83daed2))
* **scheduler:** stop auto.m3u repeats — telnet reload + key-based dedup ([#874](https://github.com/LYKNV/subwave/issues/874)) ([#878](https://github.com/LYKNV/subwave/issues/878)) ([df06ed2](https://github.com/LYKNV/subwave/commit/df06ed2b79df36105a2c681011b18cf22ea8cf5a))
* **settings:** accept Kokoro voice ids under piper so seed personas save ([#454](https://github.com/LYKNV/subwave/issues/454)) ([#457](https://github.com/LYKNV/subwave/issues/457)) ([cd24673](https://github.com/LYKNV/subwave/commit/cd2467332c25ef36ae22983b7103de679da9212c))
* **settings:** persist embedding.batchSize through update() ([1a90d21](https://github.com/LYKNV/subwave/commit/1a90d21ba1d3e8cb49295c8ecccbad8646023ffb))
* **sfx:** align under-voice stingers with the DJ's first word ([#609](https://github.com/LYKNV/subwave/issues/609)) ([69d924d](https://github.com/LYKNV/subwave/commit/69d924d5762ef0f5853596feda6366f552acf66f))
* **shows:** wire excluded playlists into pick paths + make strict filters actually strict ([#1018](https://github.com/LYKNV/subwave/issues/1018)) ([02ec7d5](https://github.com/LYKNV/subwave/commit/02ec7d526ad35ad4486ddb5a6f0b08ea8dd7f9ec))
* **skills:** drop nullable on segment object so Gemma-4 keeps its schema ([#906](https://github.com/LYKNV/subwave/issues/906)) ([#919](https://github.com/LYKNV/subwave/issues/919)) ([14907dd](https://github.com/LYKNV/subwave/commit/14907dd471aad69033c266d3abbc3f021aaadd2f))
* **state:** atomic state-dir writes, retention for logs/archive, now-playing cache ([#848](https://github.com/LYKNV/subwave/issues/848)) ([7899a45](https://github.com/LYKNV/subwave/commit/7899a459953a6f8af059beabbefdb5f362053626))
* **stations:** Brisflix Radio showed offline — url carried a /listen path ([#964](https://github.com/LYKNV/subwave/issues/964)) ([9f8085f](https://github.com/LYKNV/subwave/commit/9f8085fed5db99e75763f665016d27716a8b97ff))
* **stations:** plot 2618 Home Radio + correct Millennial FM pin ([#436](https://github.com/LYKNV/subwave/issues/436)) ([79afa90](https://github.com/LYKNV/subwave/commit/79afa90accdb7c7609dcf11b04a0895ee62cae3a))
* **stats:** read container metrics via docker-socket-proxy, not the raw socket ([#481](https://github.com/LYKNV/subwave/issues/481)) ([7a4abbb](https://github.com/LYKNV/subwave/commit/7a4abbbed7640099b089cd1d423c5893afc54456))
* **stats:** scroll the pick-source list + reliably wire the docker-socket-proxy ([#693](https://github.com/LYKNV/subwave/issues/693)) ([ba06f94](https://github.com/LYKNV/subwave/commit/ba06f94d0be18455a4a962290af9ea7712a8c5a9))
* **tagger:** hide chat-only providers from the embedding picker ([#493](https://github.com/LYKNV/subwave/issues/493)) ([#497](https://github.com/LYKNV/subwave/issues/497)) ([678bf7f](https://github.com/LYKNV/subwave/commit/678bf7f9bb9f472f4fed69f0ff1aadddd916a79f))
* **tagger:** mute raw-debug stderr mirror in the standalone tagger ([#740](https://github.com/LYKNV/subwave/issues/740)) ([b7d6c0c](https://github.com/LYKNV/subwave/commit/b7d6c0caa4188c25eac206a08206f9f7e6ba16ec))
* transient stream-status no longer tears down playback ([#463](https://github.com/LYKNV/subwave/issues/463), rebased to develop) ([#466](https://github.com/LYKNV/subwave/issues/466)) ([8910200](https://github.com/LYKNV/subwave/commit/891020024d4e8c9b07fe4996b984934eceb3ece2))
* **tts:** apply speech speed locally for openai-compatible cloud TTS ([#982](https://github.com/LYKNV/subwave/issues/982)) ([bb78a0d](https://github.com/LYKNV/subwave/commit/bb78a0d910f29f623aaaa02fb00c8c4cd5b98fd9)), closes [#942](https://github.com/LYKNV/subwave/issues/942)
* **tts:** build the AIO kokoro venv on Python 3.12 so misaki 0.9.4 installs ([#909](https://github.com/LYKNV/subwave/issues/909)) ([69c66ac](https://github.com/LYKNV/subwave/commit/69c66ac5a9d61e2b758cbd0d4a2cd23785129f2e))
* **tts:** existsSync Kokoro model/voices in isAvailable() ([#655](https://github.com/LYKNV/subwave/issues/655)) ([297eb55](https://github.com/LYKNV/subwave/commit/297eb55071da566c5f57bd87cd35740726e325ab))
* **tts:** honour speech speed for openai-compatible cloud TTS servers ([#897](https://github.com/LYKNV/subwave/issues/897)) ([9bb5b4f](https://github.com/LYKNV/subwave/commit/9bb5b4fad1b9b8c4a42700a071cf8c0add2becf1))
* **tts:** install misaki in the AIO image so Kokoro works again ([#896](https://github.com/LYKNV/subwave/issues/896)) ([033c844](https://github.com/LYKNV/subwave/commit/033c8443d6623c61cfae976fd9fd83a684a61151))
* **tts:** normalize display text to spoken form; never air intro fragments ([#965](https://github.com/LYKNV/subwave/issues/965)) ([04c3393](https://github.com/LYKNV/subwave/commit/04c339321e8b345d3d8544a716a6f99dd47699c0))
* **tts:** run Chatterbox on RTX 50-series (Blackwell) GPUs ([#685](https://github.com/LYKNV/subwave/issues/685)) ([53a4751](https://github.com/LYKNV/subwave/commit/53a4751888491324e3317c7c42adf4e24ebef302))
* **tts:** surface silent engine fallbacks + guide operators to matching-language voices ([#691](https://github.com/LYKNV/subwave/issues/691), [#725](https://github.com/LYKNV/subwave/issues/725)) ([#761](https://github.com/LYKNV/subwave/issues/761)) ([4feca91](https://github.com/LYKNV/subwave/commit/4feca91f05aeb2750ed008ba09dda95231c538f9))
* **ui:** render on-air timestamps in the station timezone, not the viewer's ([#418](https://github.com/LYKNV/subwave/issues/418)) ([#421](https://github.com/LYKNV/subwave/issues/421)) ([bbb6081](https://github.com/LYKNV/subwave/commit/bbb6081768111e65938f46772110770dae59bf5d))
* **unraid:** lowercase CA app name to "subwave" + broaden search terms (discoverability) ([#512](https://github.com/LYKNV/subwave/issues/512)) ([a1d49c4](https://github.com/LYKNV/subwave/commit/a1d49c46879956f845a3a19ce3af4f487db749d4))
* **web:** clamp DJ thinking line so long scripts don't shove artwork under the header ([#486](https://github.com/LYKNV/subwave/issues/486)) ([2540fc3](https://github.com/LYKNV/subwave/commit/2540fc3095b675fc170cd6442b253fb66f1f5763))
* **web:** derive manual guide count from GUIDE array ([#600](https://github.com/LYKNV/subwave/issues/600)) ([babe2ab](https://github.com/LYKNV/subwave/commit/babe2ab9f7566548403d4604caeda463a7bfc50d))
* **web:** don't false-flag raw LLM-request dumps as warnings in tagging log ([#679](https://github.com/LYKNV/subwave/issues/679)) ([bc9e562](https://github.com/LYKNV/subwave/commit/bc9e5621f09a87ad019065e45b9e8eebcefd94af))
* **web:** gate backup tab's disk-list fetch on auth hydration ([#404](https://github.com/LYKNV/subwave/issues/404)) ([#647](https://github.com/LYKNV/subwave/issues/647)) ([c8dd8ae](https://github.com/LYKNV/subwave/commit/c8dd8ae262095663f6d97f67a48981587d8901e1))
* **webhooks:** gate track.play on listener count ([#856](https://github.com/LYKNV/subwave/issues/856)) ([bdfab76](https://github.com/LYKNV/subwave/commit/bdfab764e7373bd70604afa7061d0a7ee2ad3a14))
* **web:** keep the DJ announcement clear of the visualizer ([#576](https://github.com/LYKNV/subwave/issues/576)) ([#589](https://github.com/LYKNV/subwave/issues/589)) ([f58abbf](https://github.com/LYKNV/subwave/commit/f58abbffc8a8a1ddbb1530ccbc404159761d375c))
* **web:** make the volume knob touch-friendly with a relative vertical drag ([#641](https://github.com/LYKNV/subwave/issues/641)) ([bc6a526](https://github.com/LYKNV/subwave/commit/bc6a5267c7383cbc8f6dfa664a3ccabd59a60271)), closes [#627](https://github.com/LYKNV/subwave/issues/627)
* **web:** reduce admin/doctor horizontal padding on mobile ([#644](https://github.com/LYKNV/subwave/issues/644)) ([f5c93b5](https://github.com/LYKNV/subwave/commit/f5c93b5bf34175b495004a33c589f0037ebfca3a))
* **web:** resolve schedule "On now" in station timezone, not browser ([#510](https://github.com/LYKNV/subwave/issues/510)) ([1033d6f](https://github.com/LYKNV/subwave/commit/1033d6f4d3dd88a0bca880f12cc034e4ce7cfa88))
* **web:** restore Select dropdown height clamp under Tailwind v4 ([#360](https://github.com/LYKNV/subwave/issues/360)) ([c4a9255](https://github.com/LYKNV/subwave/commit/c4a92557161b340f1e5ece824eaad5637db8f1d9))
* **web:** transparent favicon so the disc reads as round, not a black square ([#885](https://github.com/LYKNV/subwave/issues/885)) ([8a36227](https://github.com/LYKNV/subwave/commit/8a36227da3826bf78c90d48efa8edada25c5a894))
* **web:** tune out abandoned player tabs + back off reconnects ([#348](https://github.com/LYKNV/subwave/issues/348)) ([f848fe3](https://github.com/LYKNV/subwave/commit/f848fe367fd849da8ff09ef2c97167999dd40afb))
* **web:** visualiser — distinct low-end bars, and a Safari dead-analyser watchdog ([#988](https://github.com/LYKNV/subwave/issues/988)) ([4d82da2](https://github.com/LYKNV/subwave/commit/4d82da28f67b699356e622df7a7301698a2d2b7b))


### Performance

* **tagger:** parallel enrichment, phase timings, heavy-embedding-model warning ([#662](https://github.com/LYKNV/subwave/issues/662)) ([7d9f9be](https://github.com/LYKNV/subwave/commit/7d9f9be211e54e5ec5c20f8449b756f32ec68990))
* **web:** canvas waveform visualizer — log-frequency bars, calm-mode gating ([#973](https://github.com/LYKNV/subwave/issues/973)) ([4021b21](https://github.com/LYKNV/subwave/commit/4021b211ab0d593e4fb601f9da682e594e3a06be))


### Documentation

* add Discord invite to README and landing footer ([#347](https://github.com/LYKNV/subwave/issues/347)) ([44a5796](https://github.com/LYKNV/subwave/commit/44a5796e3c24f979aa3420a789339df3e9881d83))
* **app:** mark iOS app live on the App Store ([#374](https://github.com/LYKNV/subwave/issues/374)) ([d502cd9](https://github.com/LYKNV/subwave/commit/d502cd9483de9b1a333989d953d849f0867f6a80))
* **landing:** refresh landing page + README with features shipped since mid-June ([#881](https://github.com/LYKNV/subwave/issues/881)) ([5b44853](https://github.com/LYKNV/subwave/commit/5b448538ec7e38dc8ffeb52502efb3a8518415a2))
* **manual:** correct the Settings panel list on the admin manual page ([#887](https://github.com/LYKNV/subwave/issues/887)) ([1fac4d8](https://github.com/LYKNV/subwave/commit/1fac4d85cae09f845265a6d11688493aa77e380a))
* **manual:** document locca + embeddings, link admin sections to the manual ([#433](https://github.com/LYKNV/subwave/issues/433)) ([1fbc368](https://github.com/LYKNV/subwave/commit/1fbc3683d843ebe8507e888e289d8cffa93771d9))
* **manual:** fact-check and expand the How the DJ Works page ([#989](https://github.com/LYKNV/subwave/issues/989)) ([1f3a2e5](https://github.com/LYKNV/subwave/commit/1f3a2e5b1cbea31022cb7e354e952c5134b05a15))
* **manual:** recommend Gemma 4 12B as the local sweet spot ([#439](https://github.com/LYKNV/subwave/issues/439)) ([6ee69dd](https://github.com/LYKNV/subwave/commit/6ee69dde0d498aa837de9f1b25a4a95ce2a0a2c9))
* music licensing disclaimer, FAQ, Terms page + private-station guide ([#452](https://github.com/LYKNV/subwave/issues/452)) ([e2e48cf](https://github.com/LYKNV/subwave/commit/e2e48cf917206f961b21241e005216adafc1bebd))
* **news:** dispatch on running Chatterbox on an nvidia GPU ([#487](https://github.com/LYKNV/subwave/issues/487)) ([aebfa7f](https://github.com/LYKNV/subwave/commit/aebfa7f50a03f0eea06a1d5c70265438bc481e32))
* **news:** dispatch on the four DJ transition effects ([#826](https://github.com/LYKNV/subwave/issues/826)) ([705a0c3](https://github.com/LYKNV/subwave/commit/705a0c3f416aec22e64168762f0f397137f64fba))
* **news:** skill-sharing dispatch + refresh manual skills page ([#849](https://github.com/LYKNV/subwave/issues/849)) ([13b2eab](https://github.com/LYKNV/subwave/commit/13b2eabcf2aabaea543e7a454cac0daec652ed0a))
* **readme:** embed showreel video ([#409](https://github.com/LYKNV/subwave/issues/409)) ([5ce070c](https://github.com/LYKNV/subwave/commit/5ce070cefe5be689080e419003e9731060bfb678))
* remove superpowers design specs ([#884](https://github.com/LYKNV/subwave/issues/884)) ([bf1d784](https://github.com/LYKNV/subwave/commit/bf1d784692d19a37589f814f6fde660869c44345))
* **skills:** add subwave-discord-release skill ([#941](https://github.com/LYKNV/subwave/issues/941)) ([e7bc827](https://github.com/LYKNV/subwave/commit/e7bc82730f982ed7ab43fcde459285528986c893))
* **skills:** capture the live-app version-bump rule ([#379](https://github.com/LYKNV/subwave/issues/379)) ([884bda7](https://github.com/LYKNV/subwave/commit/884bda7df4fa289d3ea19461430bb3a5651c153b))
* **skills:** document community sharing, catalog install & zip export/import ([#841](https://github.com/LYKNV/subwave/issues/841)) ([3a4e000](https://github.com/LYKNV/subwave/commit/3a4e00078d5426dfaa41b487b085516fb192fc27))
* **skills:** update app release skills for live store status ([#377](https://github.com/LYKNV/subwave/issues/377)) ([e6fae20](https://github.com/LYKNV/subwave/commit/e6fae2077ee58efcc3ffb76f0bdaf1854a0cb043))
* **unraid:** explain switching the one-click AIO install to the heavy image ([#747](https://github.com/LYKNV/subwave/issues/747)) ([40a095f](https://github.com/LYKNV/subwave/commit/40a095ff8e7aae3965b3f9301f6310a16b0a56dc))
* **unraid:** make BYO reverse-proxy (NPM/SWAG/Traefik) guidance front-and-center ([#513](https://github.com/LYKNV/subwave/issues/513)) ([9793302](https://github.com/LYKNV/subwave/commit/9793302fab43061d761cc0a973b7d5e7976911e2))
* **unraid:** mark CA listing live, humanize Overview + setup pages, add news dispatch ([#507](https://github.com/LYKNV/subwave/issues/507)) ([9254956](https://github.com/LYKNV/subwave/commit/9254956062dd353369f933fceb3c7b181581a00a))
* **web:** announce mobile apps live + copy cleanup ([#364](https://github.com/LYKNV/subwave/issues/364)) ([60ddd5a](https://github.com/LYKNV/subwave/commit/60ddd5afeea83f7a0a71138d40089f72bc88aa7e))


### Refactors

* **admin:** move hourly archive card from danger zone to archives tab ([#650](https://github.com/LYKNV/subwave/issues/650)) ([22b6d6e](https://github.com/LYKNV/subwave/commit/22b6d6e3b89c6dfd8fea0fb07624015acf09f3db))
* **admin:** move jingle & sfx create/import into modals behind buttons ([#652](https://github.com/LYKNV/subwave/issues/652)) ([dcff131](https://github.com/LYKNV/subwave/commit/dcff1316d5cb19794841e70de3e994206cc956d0))
* **admin:** slim Stats page — drop duplicate KPI strip + cost displays ([#431](https://github.com/LYKNV/subwave/issues/431)) ([da3dab2](https://github.com/LYKNV/subwave/commit/da3dab29bd00001bf71dc28382ed1b9cffa58621))
* **llm:** split sdk.ts into internal/** modules with data-driven provider capabilities ([#414](https://github.com/LYKNV/subwave/issues/414)) ([3fba6bf](https://github.com/LYKNV/subwave/commit/3fba6bf9591627da24011be1c869212874c1ba3f))
